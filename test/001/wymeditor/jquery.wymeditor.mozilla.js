...
function WymClassMozilla(wym) {
	...
	this._wym = wym;
        ...
        // it's not needed because of inheritances
        //this._html = wym._html;
};
...
WymClassMozilla.prototype.selection = {
...
WymClassMozilla.prototype.getSelection = function()
{
    var _sel = this._iframe.contentWindow.getSelection();
    // NOTE v.mische can startNode/endNote be phantom nodes?
    this.selection.startNode = _sel.getRangeAt(0).startContainer;
    this.selection.endNode = _sel.getRangeAt(0).endContainer;
    this.selection.startOffset = _sel.getRangeAt(0).startOffset;
    this.selection.endOffset = _sel.getRangeAt(0).endOffset;
    this.selection.isCollapsed = _sel.isCollapsed;
    this.selection.original = _sel;
    this.selection.container = $j(this.selection.startNode).parentsOrSelf(
