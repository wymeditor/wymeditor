...
asyncTest("Custom dialog options don't change future defaults", function () {
    var startingDefault = WYMeditor.DEFAULT_DIALOG_OPTIONS.hrefSelector;
    QUnit.expect(3);

    notEqual(startingDefault, '.wym_customized_thing');
