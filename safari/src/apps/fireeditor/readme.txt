...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\fireeditor on
     Windows, /home/user/dev/fireeditor on Linux) in a file named
     fireeditor@david.wees and copy that file to
